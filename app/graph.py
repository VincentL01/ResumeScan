...
GOOGLE_MODEL_NAME = st.secrets.get("GOOGLE_MODEL_NAME", "gemini-1.5-flash")
model = ChatGoogleGenerativeAI(model=GOOGLE_MODEL_NAME)
...
def build_resume_scan_graph():
    ...
    print("GOOGLE_API_KEY", st.secrets["GOOGLE_API_KEY"])
